                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="key_{{$key}}" value="Si" required @if($calidadpers_data['key_'.$key] == 'Si') checked @endif>
                                    </td>
                                    <td>
                                        <input type="radio" name="key_{{$key}}" value="No" required @if($calidadpers_data['key_'.$key] == 'No') checked @endif>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="textarea_{{$key}}" rows="1" cols="10">{{$calidadpers_data['textarea_'.$key]}}</textarea>
                                    </td>
                                </tr>
                            </tbody>
                        @endforeach
