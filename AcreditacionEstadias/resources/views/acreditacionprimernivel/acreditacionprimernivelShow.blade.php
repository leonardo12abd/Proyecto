                                ...
                                <center>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input onchange="changeEstructuraClue()" name="tipo__estructura"  type="radio" id="estructura_clues0" value="basica"value="{{ $data20->tipo__estructura }}"> Básica
                                        </label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td><input type="number" name="key_11{{$key}}"  value="{{isset($data20->data20['key_11'.$key]) ? $data20->data20['key_11'.$key] : ''}}" min="0" class="form-control" type="text" id="salaespera_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->saladeespera_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_12{{$key}}"  value="{{isset($data20->data20['key_12'.$key]) ? $data20->data20['key_12'.$key] : ''}}" min="0" class="form-control" type="text" id="consultorio_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->consultorios_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_13{{$key}}"  value="{{isset($data20->data20['key_13'.$key]) ? $data20->data20['key_13'.$key] : ''}}" min="0" class="form-control" type="text" id="medicinaprev_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->medicinaprev_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_14{{$key}}"  value="{{isset($data20->data20['key_14'.$key]) ? $data20->data20['key_14'.$key] : ''}}" min="0" class="form-control" type="text" id="areaesterilizacion_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->areaesterilizacion_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_15{{$key}}"  value="{{isset($data20->data20['key_15'.$key]) ? $data20->data20['key_15'.$key] : ''}}" min="0" class="form-control" type="text" id="estomatologia_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->estomatologia_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_16{{$key}}"  value="{{isset($data20->data20['key_16'.$key]) ? $data20->data20['key_16'.$key] : ''}}" min="0" class="form-control" type="text" id="psicologia_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->psicologia_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_17{{$key}}"  value="{{isset($data20->data20['key_17'.$key]) ? $data20->data20['key_17'.$key] : ''}}" min="0" class="form-control" type="text" id="archivo_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->archivo_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_18{{$key}}"  value="{{isset($data20->data20['key_18'.$key]) ? $data20->data20['key_18'.$key] : ''}}" min="0" class="form-control" type="text" id="farmacia_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->farmacia_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_19{{$key}}"  value="{{isset($data20->data20['key_19'.$key]) ? $data20->data20['key_19'.$key] : ''}}" min="0" class="form-control" type="text" id="otrasareas_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->otrasareas_emi_is_required == 0) disabled @endif></td>
                                            <td><input type="number" name="key_20{{$key}}"  value="{{isset($data20->data20['key_20'.$key]) ? $data20->data20['key_20'.$key] : ''}}" min="0" class="form-control" type="text" id="total_{{$key}}" onchange="sumarr({{$key}})" onkeypress="sumarr({{$key}})" @if($emi->total_emi_is_required == 0) disabled @endif></td>
                                          </tr>
                                          @endforeach
                                        </tbody>
