                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="number" name="key0_{{$key}}" value="{{isset($data20->data20['key0_'.$key]) ? $data20->data20['key0_'.$key] : '0'}}" min="0" class="form-control" type="text" id="fachada2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->fachada_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key1_{{$key}}" value="{{isset($data20->data20['key1_'.$key]) ? $data20->data20['key1_'.$key] : '0'}}" min="0" class="form-control" type="text" id="salaespera2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->saladeespera_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key2_{{$key}}" value="{{isset($data20->data20['key2_'.$key]) ? $data20->data20['key2_'.$key] : '0'}}" min="0" class="form-control" type="text" id="sanitario2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->sanitarios_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key3_{{$key}}" value="{{isset($data20->data20['key3_'.$key]) ? $data20->data20['key3_'.$key] : '0'}}" min="0" class="form-control" type="text" id="consultorio2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->consultorios_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key4_{{$key}}" value="{{isset($data20->data20['key4_'.$key]) ? $data20->data20['key4_'.$key] : '0'}}" min="0" class="form-control" type="text" id="medicinaprev2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->medicinaprev_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key5_{{$key}}" value="{{isset($data20->data20['key5_'.$key]) ? $data20->data20['key5_'.$key] : '0'}}" min="0" class="form-control" type="text" id="farmacia2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->farmacia_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key6_{{$key}}" value="{{isset($data20->data20['key6_'.$key]) ? $data20->data20['key6_'.$key] : '0'}}" min="0" class="form-control" type="text" id="areaesterilizacion2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->esterilizacion_infra_is_required == 0) disabled @endif></td>
                                          <td><input type="number" name="key7_{{$key}}" value="{{isset($data20->data20['key7_'.$key]) ? $data20->data20['key7_'.$key] : '0'}}" min="0" class="form-control" type="text" id="otrasareas2_{{$key}}" onchange="sumarr2({{$key}})" onkeypress="sumarr2({{$key}})" @if($infra->otrasareas_infra_is_required == 0) disabled @endif></td>
                                        </tr>
                                        @endforeach
                                      </tbody>
                                    </table>
